...
# pm mapper client username and password
GLOBAL_PMMAPPER_CLIENT_USERNAME = dcae@dcae.onap.org
GLOBAL_PMMAPPER_CLIENT_PASSWORD = demo123456!
GLOBAL_PMMAPPER_AUTHENTICATION = [GLOBAL_PMMAPPER_CLIENT_USERNAME, GLOBAL_PMMAPPER_CLIENT_PASSWORD]