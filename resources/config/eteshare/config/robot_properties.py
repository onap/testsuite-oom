...
GLOBAL_INJECTED_CDS_BLUEPRINT_PROCESSOR_IP_ADDR = 'cds-blueprints-processor-http.{{include "common.namespace" .}}'
...
GLOBAL_CDS_SERVER_PROTOCOL = "http"
GLOBAL_CDS_HEALTH_SERVER_PORT = "8080"
GLOBAL_CDS_USERNAME = ccsdkapps
GLOBAL_CDS_PASSWORD = ccsdkapps
GLOBAL_CDS_AUTHENTICATION = [GLOBAL_CDS_USERNAME, GLOBAL_CDS_PASSWORD]
